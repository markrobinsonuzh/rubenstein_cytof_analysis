# 
# knitr::spin("cytofWorkflow_Cancer_20clusts_merge2_PDFs.R")
...
## ----cluster-merging1----------------------------------------------------
cluster_merging1_filename <- "CK_2017-12-18merge2.xlsx"
...
ggsave(filename = "heatmap_panel.pdf", pchw$gtable, width = 10, height = 6)
